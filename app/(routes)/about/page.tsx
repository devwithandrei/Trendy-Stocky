...
const AboutPage = async () => {
  const billboard = await getBillboard("81460d76-a7b9-4f70-b26f-41bd8cb731cc");
  const fastDeliveryBillboard = await getBillboard("81460d76-a7b9-4f70-b26f-41bd8cb731cc");
