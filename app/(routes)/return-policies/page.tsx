      ...
      <div className="space-y-10 pb-10">
        ...
        <div className="caligrafic-text" style={{ color: '#0066ff', fontFamily: 'cursive', textAlign: 'center' }}>
          <p style={{ fontSize: '1.3em' }}>
            Welcome to the Return Policies of <strong>Trendy Stocky</strong>. This page outlines how we collect, use, and protect your personal information when you use our website.
          </p>
        ...
        {/* End of return policies Content */}
      </div>
    </Container>
  );
};
