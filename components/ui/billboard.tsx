...
interface BillboardProps {
  data: BillboardType;
  textColor?: string; // Adding a prop to customize text color
}
...
const Billboard: React.FC<BillboardProps> = ({ data, textColor }) => {
  ...
  const textStyle = {
    color: textColor || '#299A16', // Use the specified color or default to #299A16
  };
        ...
        <div className="h-full w-full flex flex-col justify-center items-center text-center gap-y-8">
          <div className="font-bold text-3xl sm:text-5xl lg:text-6xl sm:max-w-xl max-w-xs">
            <div className="Typewriter" data-testid="typewriter-wrapper">
              <span className="Typewriter__wrapper" style={textStyle}>
                {displayText}
              </span>
